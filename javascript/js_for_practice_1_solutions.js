...
/*
  ...
  Example:
    for (let i = 1; i <= 5; i++) {
      1. initialization: let i = 1 runs once.
      2. condition: i <= 5 checks if i is less than or equal to 5 (true for 1, 2, 3, 4, 5).
      3. final-expression: i++ runs after each console.log, increasing i by 1.
*/
