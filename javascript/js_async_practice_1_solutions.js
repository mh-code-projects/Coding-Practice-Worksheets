...
const warningTimeoutID = setTimeout(criticalWarning, 5000);
setTimeout(cancelWarning, 2000);
function criticalWarning(){
	console.log('CRITCAL WARNING!');
};
function cancelWarning(){
	clearTimeout(warningTimeoutID);
	console.log('Warning cleared just in time!');
};
...
let flashCount = 0;
//SEE REMAINING SOLUTION AT CHALLENGE 7//
