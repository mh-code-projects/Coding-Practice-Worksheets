...
// let charlie = ...
// console.log(charlie); // Should output: { id: 3, name: "Charlie", grade: "A" }
...
// let keyboardProduct = ...
// console.log(keyboardProduct); // Should output: { id: 'p3', name: 'Keyboard', price: 75, category: 'electronics' }

// let missingProduct = ...
// console.log(missingProduct); // Should output: undefined
...
// let firstBStudent = ...
// console.log(firstBStudent); // Should output: { id: 2, name: "Bob", grade: "B" }
...
// let expensiveElectronic = ...
// console.log(expensiveElectronic); // Should output: { id: 'p1', name: 'Laptop', price: 1200, category: 'electronics' }
...
// let studentTwo = getStudentById(2);
// console.log(studentTwo); // Should output: { id: 2, name: "Bob", grade: "B" }/*
  The `.find()` method is a powerful tool for searching through arrays.
