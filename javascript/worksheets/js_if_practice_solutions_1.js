...
*/
if (highScores.includes(100)) {
	console.log("A perfect score was acheived!");
}
...
*/
const loginMessage = (userLoggedIn === true) ? "Welcome back!" : "Please sign up or log in.";
...
*/
if (!(userAge > 65) && userLoggedIn === true) {
	console.log("Eligible for standard services");
} else {console.log("Not eligible for standard services")};
