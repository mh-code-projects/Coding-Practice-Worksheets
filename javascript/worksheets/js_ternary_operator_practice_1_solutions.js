...
let weatherReport = (dailyTemperatureF > 85) ? "Hot Day" : "Mild day";
...
const dayStatus = (currentDay === "Saturday" || currentDay === "Sunday") ? "Weekend Fun!" : "Boring weekday...";
...
const transactionFee = (userCredits < 50) ? 5 : 0;
...
const finalPrice = (hasCoupon === true) ? itemPrice * 0.9 : itemPrice;
...
const orderPriority = (inventoryCount === 0) ? "Out of Stock" : (isUrgent ? "High Priority" : "Standard Priority");
...
let isLoggedIn = true;
const authAction = (isLoggedIn ? "Go to Dashboard" : "Show Login Modal");
...
let userSubmittedName = "";
const assignedUsername = (userSubmittedName ? userSubmittedName : "Guest User");
...
let userValue = -5
const valueLabel = (userValue > 0 ? "Positive Value" : "Negative Value");
...
*/
const itemPrice = 120.00;
let shippingCost = (itemPrice > 150 ? 0 : (itemPrice >= 50 ? 8 : 5));
